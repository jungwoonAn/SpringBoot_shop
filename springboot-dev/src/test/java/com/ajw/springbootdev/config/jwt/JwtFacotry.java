...
public class JwtFacotry {
    ...
    @Builder
    public JwtFacotry(String subject, Date issuedAt, Date expiration,
    ...
    public static JwtFacotry withDefaultValues() {
        return JwtFacotry.builder().build();
    }
